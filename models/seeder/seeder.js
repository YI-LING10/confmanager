...
mongoose.connect('mongodb+srv://mina1203:20210113@cluster0.lidfj.mongodb.net/conf-main?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })

mongoose.connection.once('open', () => { // 連線成功
    console.log(`資料庫連線成功！ mongodb://localhost/conf-main`)
