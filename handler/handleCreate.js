...
module.exports = async (confData, user) => {
    // 取得輸入的資料
    const { name, startTime, endTime, chairId, topic, roomId, attendees,attendees2, attendTypes,roomId2 } = confData
    ...
    */
    ...
    // 生成第二會議室
    const secondroom=SecondRoom({confId: conf._id,name:roomId2,isExist: 1})
